...
echo "ALTER  USER     gridforge_user WITH PASSWORD '$FORGE_DB_PASS';" | sudo -u postgres psql
echo "ALTER  USER     postgres       WITH PASSWORD '$FORGE_DB_PASS';" | sudo -u postgres psql
