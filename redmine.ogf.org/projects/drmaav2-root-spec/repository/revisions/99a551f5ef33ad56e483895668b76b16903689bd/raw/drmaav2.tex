...
\title{Distributed Resource Management Application API Version 2.2 (DRMAA)}  
\newcommand{\shortdoctitle}{DRMAA}  
\newcommand{\authorsshort}{Peter Tröger, TU Chemnitz\footnotemark[1]\\Roger Brobst, Cadence Design Systems\\Daniel Gruber, Univa\\Mariusz Mamoński, PSNC\\Daniel Templeton, Cloudera}  
\newcommand{\publicationdate}{November 2016}  
%\newcommand{\revisiondate}{February 2016}  
\newcommand{\copyrightyears}{2005-2016}  
\newcommand{\docseries}{GFD-R-P.231}  % GWD-R, GWD-I or GWD-C (for working drafts), GFD-I, GFD-R, or GFD-C
...
This document obsoletes GFD-R.022 \cite{gfd.22}, GFD-R-P.130 \cite{gfd.130}, GWD-R.133 \cite{gfd.133} and GFD-R-P.194 \cite{gfd.194}.\\
...
\lstinputlisting[linerange=ResourceLimits-End]{drmaav2.idl}
