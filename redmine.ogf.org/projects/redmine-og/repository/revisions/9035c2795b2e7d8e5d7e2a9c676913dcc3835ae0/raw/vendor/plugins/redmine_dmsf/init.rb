...
Redmine::Plugin.register :redmine_dmsf do
  ...
  project_module :dmsf do
    ...
    permission :folder_deletion, {:dmsf => [:delete]}
    permission :folder_manipulation, {:dmsf => [:new, :create, :edit, :save, :edit_root, :save_root]}
    permission :file_deletion, {:dmsf_files => [:delete_revision, :delete]}
    permission :file_manipulation, {:dmsf_files => [:create_revision, :lock, :unlock],
      :dmsf_upload => [:upload_files, :upload_file, :commit_files]}
    permission :file_approval, {:dmsf_files => [:notify_activate, :notify_deactivate], 
